...
- ⬇️ **Download** — **[Rook-Setup-1.5.12.exe](https://github.com/bringfire/rook-release/releases/download/v1.5.12/Rook-Setup-1.5.12.exe)** (direct) · [v1.5.12 release page](https://github.com/bringfire/rook-release/releases/tag/v1.5.12) · [all releases](https://github.com/bringfire/rook-release/releases)
...
1. Download the installer — [Rook-Setup-1.5.12.exe](https://github.com/bringfire/rook-release/releases/download/v1.5.12/Rook-Setup-1.5.12.exe) — or the [latest release](https://github.com/bringfire/rook-release/releases/latest).
