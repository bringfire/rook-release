...
- ⬇️ **Download** — **[Rook-Setup-1.6.0.exe](https://github.com/bringfire/rook-release/releases/download/v1.6.0/Rook-Setup-1.6.0.exe)** (direct) · [latest release](https://github.com/bringfire/rook-release/releases/latest) · [all releases](https://github.com/bringfire/rook-release/releases)
...
1. Download the installer — [Rook-Setup-1.6.0.exe](https://github.com/bringfire/rook-release/releases/download/v1.6.0/Rook-Setup-1.6.0.exe) — or the [latest release](https://github.com/bringfire/rook-release/releases/latest).
