...
- ⬇️ **Download** — **[Rook-Setup-1.5.18.exe](https://github.com/bringfire/rook-release/releases/download/v1.5.18/Rook-Setup-1.5.18.exe)** (direct) · [latest release](https://github.com/bringfire/rook-release/releases/latest) · [all releases](https://github.com/bringfire/rook-release/releases)
...
1. Download the installer — [Rook-Setup-1.5.18.exe](https://github.com/bringfire/rook-release/releases/download/v1.5.18/Rook-Setup-1.5.18.exe) — or the [latest release](https://github.com/bringfire/rook-release/releases/latest).
