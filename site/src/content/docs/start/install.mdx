...
1. Download the installer directly —
   **[Rook-Setup-1.5.12.exe](https://github.com/bringfire/rook-release/releases/download/v1.5.12/Rook-Setup-1.5.12.exe)** —
   or open the [v1.5.12 release page](https://github.com/bringfire/rook-release/releases/tag/v1.5.12)
