...
<div class="rook-download-wrap">
  <a class="rook-download" href="https://github.com/bringfire/rook-release/releases/download/v1.5.15/Rook-Setup-1.5.15.exe" download>
    <span class="rook-download-label">Download Rook for Windows</span>
    <span class="rook-download-meta">v1.5.15 · Windows · Rhino&nbsp;8</span>
  </a>
</div>
...
1. Download the installer directly —
   **[Rook-Setup-1.5.15.exe](https://github.com/bringfire/rook-release/releases/download/v1.5.15/Rook-Setup-1.5.15.exe)** —
   or open the [v1.5.15 release page](https://github.com/bringfire/rook-release/releases/tag/v1.5.15)
